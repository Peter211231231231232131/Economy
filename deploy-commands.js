...
const commands = [
    // ... all the existing commands like /link, /work, /market etc.
    ...
    { name: 'craft', description: 'Craft an item from resources.', options: [{ name: 'item_name', type: 3, description: 'The name of the item you want to craft', required: true }] },
