// deploy-commands.js (Verbose Debugging Version)
const { REST, Routes } = require('discord.js');

// IMPORTANT: We need to use dotenv to load the environment variables from the .env file for this script to work.
// Make sure you have run 'npm install dotenv' in the shell before.
...
if (!token) console.error("ERROR: DISCORD_TOKEN is missing!");
if (!clientId) console.error("ERROR: DISCORD_CLIENT_ID is missing!");
// --------------------

if (!token || !clientId) {
    throw new Error("Missing secrets! Check the logs above.");
}

const commands = [
    // This is the full, final list of commands
    ...
    { name: 'craft', description: 'Craft an item from resources.', options: [{ name: 'item_name', type: 3, description: 'The name of the item to craft', required: true }] },
